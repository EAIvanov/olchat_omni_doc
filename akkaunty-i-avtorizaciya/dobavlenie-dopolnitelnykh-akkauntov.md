...
Олчат ОМНИ позволяет подключить несколько аккаунтов Telegram и МАКС к порталу Битрикс24. Для каждого аккаунта можно создать отдельную Открытую линию.
...
* [Для МАКС](avtorizaciya-maks.md) — используйте способ авторизации, предусмотренный сервисом (QR-код, токен и т.д.).
