...
Роботы МАКС Олчат ОМНИ предназначены для автоматизации работы с диалогами и групповыми чатами в мессенджере МАКС в рамках интеграции с Битрикс24.
...
Роботы МАКС выполняются автоматически в рамках настроенных бизнес-процессов Битрикс24. Они срабатывают при переходе лида, сделки или другого объекта CRM (системы управления взаимоотношениями с клиентами) на определённую стадию, а также могут использоваться в сценариях автоматизации коммуникаций через мессенджер МАКС.
